    ...
    >
      ...
      <div class="flex flex-col gap-8">
        <div class="text-center">
          ...
          <p class="mt-2 font-body text-body text-blue-muted">Log in to your DriftCore account.</p>
        </div>
            ...
            <div class="flex flex-col gap-1.5">
              ...
              <input
                ...
                :class="errors.email
                  ...
                  : 'border-navy/20 focus:border-cyan'"
              />
            ...
            <div class="flex flex-col gap-1.5">
              <div class="flex items-center justify-between">
                ...
                <button
                  type="button"
                  @click="openForgot"
                  class="font-body text-sm text-blue-muted transition-colors hover:text-navy"
                >
                  Forgot password?
                </button>
              </div>
    ...
    <TransitionRoot :show="forgotOpen" as="template">
      <Dialog as="div" class="relative z-50" @close="closeForgot">
        ...
        <div class="fixed inset-0 flex items-center justify-center p-4">
          ...
          >
            <DialogPanel class="w-full max-w-sm rounded-2xl border border-navy/10 bg-cream p-8 shadow-xl">
              <template v-if="!resetSent">
                <DialogTitle class="font-heading text-h4 text-navy">Reset your password</DialogTitle>
                <p class="mt-2 font-body text-sm text-blue-muted">
                ...
                <div class="mt-5 flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    autocomplete="email"
                    placeholder="you@company.com"
                    class="w-full rounded-xl border border-navy/20 bg-cream px-4 py-3
                ...
                <div class="mt-6 flex gap-3">
                  <button
                    ...
                    class="flex-1 rounded-xl border border-navy/20 px-4 py-3 font-body text-sm
                           text-navy transition-colors hover:bg-blue-light/30"
                  >Cancel</button>
                  <button
                    type="button" @click="handleReset"
                    class="flex-1 rounded-xl bg-navy px-4 py-3 font-body text-sm text-cream
                           transition-all hover:bg-blue-muted"
                  >Send reset link</button>
                </div>
              </template>
              <template v-else>
                <div class="flex flex-col items-center gap-4 text-center">
                  <div class="flex h-12 w-12 items-center justify-center rounded-full bg-cyan/20">
                    <svg class="h-6 w-6 text-cyan" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
                  ...
                  <div>
                    ...
                    <p class="mt-1 font-body text-sm text-blue-muted">
                  ...
                  <button
                    type="button" @click="closeForgot"
                    class="mt-2 w-full rounded-xl bg-navy px-6 py-3 font-body text-sm text-cream
                           transition-all hover:bg-blue-muted"
                  >Done</button>
                </div>
              </template>
    ...
    <Teleport to="body">
      <Transition name="overlay-fade">
        <div
          ...
          class="fixed inset-0 z-[200] overflow-hidden bg-cream"
        >
            ...
            <Transition name="content-swap" mode="out-in">
              ...
              <div v-else key="done" class="flex flex-col items-center gap-6">
                ...
                <div class="flex flex-col gap-3">
                  ...
                  <p class="mx-auto max-w-sm font-body text-body text-blue-muted">
                ...
                <router-link
                  ...
                  class="font-body text-sm font-medium text-navy underline underline-offset-4
                         transition-colors hover:text-blue-muted"
                >
                  ← Back to home
                </router-link>
              </div>
...
.orb-tl {
  ...
  background: rgba(219, 231, 255, 0.55); /* blue-light */
  filter: blur(140px);
...
.orb-tr {
  ...
  background: rgba(84, 201, 235, 0.20); /* cyan */
  filter: blur(150px);
...
.orb-bl {
  ...
  background: rgba(74, 93, 135, 0.16); /* blue-muted */
  filter: blur(130px);
...
.orb-br {
  ...
  background: rgba(127, 140, 191, 0.20); /* blue-soft */
  filter: blur(160px);
